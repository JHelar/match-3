...
export const isSwapValid = (thisNode, withNode) => {
    if (!thisNode || !withNode)
        return false;
    ...
    if ((indexDiff === 1 || indexDiff === GAME_SIZE) &&
...
export const isSwapMatching = (thisNode, withNode, board) => {
    ...
    const matches = [
        ...
        .reduce((acc, pNode) => [...acc, ...getMatches(pNode, board)], []);
    return matches.length > 0;
};
//# sourceMappingURL=swapping.js.map